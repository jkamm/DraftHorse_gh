...
{
    public class SetLayoutUserText_OBSOLETE : Base.DH_ButtonComponent
    {
        /// <summary>
        /// Initializes a new instance of the SetLayoutUserText_OBSOLETE class.
        /// </summary>
        public SetLayoutUserText_OBSOLETE()
