...
{
    public class GetLayoutUserText_OBSOLETE : GH_Component
    {
        /// <summary>
        /// Initializes a new instance of the GetLayoutUserText_OBSOLETE class.
        /// </summary>
        public GetLayoutUserText_OBSOLETE()
